...
function Edit({ setMod3,nft }) {
  ...
  return (
    <>
      ...
      {success? <Successful title={successMessage} turnOff={turnOff}/>:null}
        <div className="mod3">
          ...
          <div className="mod3-card">
              <div className="nftcard" key={nft.id}>
                <div className="card-hold">
                  <div className="tops">
                    <img className="bg" crossOrigin="anonymous" src={`${domain}${nft.photo}`} alt="nftImage" />
                    <div className="glass">
                      <p>For Sale</p>
                    </div>
                  </div>
          ...
          <div className="prices">
            ...
            <span>New Price</span>
            <input type="text" name="priceInEtherium" value={input.priceInEtherium} onChange={handleInput} />
          </div>
  ...
  setMod3(false)
  swal('Opps!','Nft value must be greater than or equal to 0.2ETH','error')
              }else{
                ...
                .then(data=>{
                  if(data.status === 'error'){
                    setMod3(false)
                    return swal('Opps!',data.message,data.status)
