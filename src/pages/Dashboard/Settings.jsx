        ...
        <div className="settings-hold d-flex justify-content-between align-items-center">
            ...
            <div className="profile-hold d-flex align-items-center gap-3">
              <div className="img-hold">
                {image ? (
                  ...
                  <img crossOrigin="anonymous" src={domain + myDetails.data.photo} alt="profileImg" />
                )}
              </div>
              
              <input onChange={HandleImageChange} type="file" style={{display: "none"}} ref={inputRef}/>
              <div className="profile-name">
                <p>
                  {myDetails.data.username} {myDetails.data.userVerified&&<img src={Verified} alt="verified" />} 
                </p>
          ...
          <div className="right">
            ...
            <div className="inputs-hold">
              <input onChange={handleInput} name="currentPassword" value={input.currentPassword} className="inputs" type="password" placeholder="Current Password"/>
              <input onChange={handleInput} name="password" value={input.password} className="inputs" type="password" placeholder="New Password"/>
              <input onChange={handleInput} name="passwordConfirm" value={input.passwordConfirm} className="inputs" type="password" placeholder="Confirm Password"/>
